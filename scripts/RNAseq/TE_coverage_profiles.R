...
# Description: Generate coverage matrices for transposable elements
...
#csmit -m 20G -c 1 "/applications/R/R-3.4.0/bin/Rscript ./TE_coverage_profiles.R 2000 2kb 20 /home/ajt200/analysis/REC8_pooled/coverage/REC8_HA_Rep1_ChIP_norm_allchrs_coverage_coord_tab.bed REC8_HA_Rep1_ChIP 0.01"
