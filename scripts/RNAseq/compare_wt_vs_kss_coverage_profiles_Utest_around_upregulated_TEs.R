...
#  ChIP-seq coverage within windows along upregulated transposable elements,
#  non-differentially expressed transposable elements, and random loci.
#  Plot genotype mean coverage profiles with 95% confidence intervals as ribbons,
#  and with vertical ticks along the x-axis indicating windows in which
#  significant differences exist between genotypes

# Usage:
# /applications/R/R-3.5.0/bin/Rscript compare_wt_vs_kss_coverage_profiles_Utest_around_upregulated_TEs.R Upregulated_TEs_kss 'Upregulated' 2000 2kb '2 kb' 20 20bp 'REC8_HA_Rep2,kss_REC8_HA_Rep1' 'wt REC8-HA_Rep2,kss REC8-HA_Rep1' 'red,red4' '0.30,0.15' 0.1
