...
# Description: Plot heatmaps of features sorted by
#  coverage levels between start and end sites

# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_heatmap_sorted_combined.R REC8_HA_Rep2 REC8_HA_Rep2_arm_peaks 2000 2kb '2 kb' 20 20bp bodies
...
for(x in 1:length(ChIPseqNames)) {
  ChIPseq_col_fun <- colorRamp2(c(-1.0, -0.5, 0.0, 0.25, 0.5 , 1.0),
                                rich8to6equal)
